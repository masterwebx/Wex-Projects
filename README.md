# Current featured project: Offline Journal 📓
...
![Screenshot of Offline Journal](projects/offline-journal/splash.png)
...
- `Ctrl+B` → **Bold**
- `Ctrl+I` → _Italic_
- `Ctrl+H` → # Heading 1 (tap twice quickly for ## Heading 2)
- `Ctrl+\` → Inline code
- `Ctrl+Shift+C` → Code block
- `Ctrl+L` → Bullet list
- `Ctrl+K` → Insert link
- `Shift` (quick tap) → Jump to end of current line
