...
' S1 S3.xlsm still needs its own CopyForGraphS1S3.bas. This copies that file, opens
' the copy hidden, runs Copy for Graph there, then closes so the live sheet stays shut.
'
...
Public Sub CopyForGraphFromS1S3()
    RunCopyFromWorkbookCopy SOURCE_XLSM, "s1s3", "CopyForGraphS1S3.CopyForGraph", "CopyForGraphS1S3.bas"
End Sub
