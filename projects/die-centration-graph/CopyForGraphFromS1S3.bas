...
' Self-contained: copies S1 S3.xlsm into %TEMP%, opens that copy hidden (macros
...
' If S1 S3 is already open, uses that workbook and does not close it.
' No macro inside S1 S3 is used.
'
