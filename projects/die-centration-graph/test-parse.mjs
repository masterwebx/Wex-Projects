...
assert.match(html, /APP_VERSION = ["']1\.7\.55["']/);
...
assert.match(hta, /Import legacy data/);
assert.match(hta, /function importLegacyPicked/);
...
assert.equal(QD.VERSION, '1.7.55');
