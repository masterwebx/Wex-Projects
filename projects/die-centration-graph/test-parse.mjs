...
assert.match(html, /APP_VERSION = '1\.7\.46'/);
...
assert.match(hta, /showTab\('lookup'\)/);
assert.match(hta, /id="tabLookup"/);
assert.match(hta, /id="lookupItem"/);
