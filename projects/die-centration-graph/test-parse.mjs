...
assert.equal(QD.VERSION, '1.7.78');
...
assert.match(hta, /function deskHtmlStamp/);
...
if (fs.existsSync(releaseHtaPath) && fs.existsSync(releaseCorePath)) {
  ...
  assert.match(releasePack.app, /v1\.7\.78/);
  assert.match(releasePack.app, /QD\.VERSION = '1\.7\.78'/);
  assert.match(releasePack.app, /function fillLastChecksLazy/);
  assert.match(releasePack.app, /last-check\.js/);
  assert.match(releasePack.app, /function deskHtmlStamp/);
